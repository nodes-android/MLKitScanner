//package dk.nodes.barcodelib.camera
//
...
//class CameraSource(activity: Activity, private val graphicOverlay: GraphicOverlay) {
//
...
//            processingThread?.let { thread ->
//                assert(thread.state == Thread.State.TERMINATED)
//            }
//        }
//
...
//            synchronized(lock) {
//                pendingFrameData?.let { pending ->
//                    camera.addCallbackBuffer(pending.array())
